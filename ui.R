...
## Création du header----------------------  
    ...
    header <- 
        dashboardHeader(
            title = HTML("Observatoire des Objectifs de Développement Durable en Ile-de-France"),
            disable = FALSE,   	
            titleWidth = 300               
    )
...
## Création du siderbar ------------------------------
  ...
  siderbar <-  
    dashboardSidebar(
            width = 200,
      sidebarMenu(
        menuItem("Présentation de l'observatoire", tabName = "Présentation de l'observatoire"),
 ...
 body <-   
  dashboardBody(
    tags$head(
      ...
      tags$script("document.title = 'COMMUNE'"),
      ...
      tabItems(
        ...
        #tabItem(tabName = "Présentation de l'observatoire",
